    ...
    <div className="main-wrapper">
      <section className="cta-section theme-bg-light py-5">
        <div className="container single-col-max-width">
          <h2 className="heading text-center">Case Study: SHINDE'S EDUCATION GALLERY</h2>
          <div className="project-intro text-center">
            <p className="mb-0 lead">
              Premier coaching for school, JEE, NEET, CET, and skill development with expert faculty,
              personalized attention, and a result-oriented approach for student success.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="project-meta theme-bg-light p-4">
            <div className="row g-4 g-lg-5">
              <div className="col-md-5 col-lg-4 col-xxl-3 d-none d-md-block">
                <img className="project-thumb img-fluid rounded" src={`${process.env.PUBLIC_URL}/images/project/seg.png`} alt="seg1" />
              </div>
              <div className="col-12 col-md-7 col-lg-8 col-xxl-9">
                <div className="client-info">
                  <h3 className="client-name font-weight-bold mb-4">SHINDE'S EDUCATION GALLERY</h3>
          ...
          <div className="project-sections py-5">
            ...
            <div className="row mt-5">
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded"  src={`${process.env.PUBLIC_URL}/images/project/seg2.png`} alt="seg2" />
              </div>
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded"  src={`${process.env.PUBLIC_URL}/images/project/seg3.png`} alt="seg3" />
              </div>
            </div>
