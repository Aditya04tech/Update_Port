    ...
    <Backbtn/>
      ...
      <section className="cta-section theme-bg-light py-5">
        <div className="container single-col-max-width">
          <h2 className="heading text-center">Case Study: Ashish Mobile Shop</h2>
          <div className="project-intro text-center">
            <p className="mb-0 lead">
            Hello and welcome to Ashish Mobile Shop , where we have been established since 24 Feb 2021 . Our team comprises of technology freaks and customer care professionals who aim at connecting you with the world using advanced technology and exceptional service
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="project-meta theme-bg-light p-4">
            <div className="row g-4 g-lg-5">
              <div className="col-md-5 col-lg-4 col-xxl-3 d-none d-md-block">
                <img className="project-thumb img-fluid rounded"  src={`${process.env.PUBLIC_URL}/images/project/ams1.png`} alt="ams1" />
              </div>
              <div className="col-12 col-md-7 col-lg-8 col-xxl-9">
                <div className="client-info">
                  <h3 className="client-name font-weight-bold mb-4"> Ashish Mobile Shop</h3>
                  <ul className="client-meta list-unstyled">
                    <li className="mb-2">
                      <i className="fas fa-industry fa-fw me-2" />
                      <strong>Industry:</strong> Mobile & Repair
                    </li>
                    <li className="mb-2">
                    ...
                    <li className="mb-2">
                      ...
                      <a className="theme-link" href="https://ashishmobile.in/">https://ashishmobile.in/</a>
                    </li>
                  </ul>
          ...
          <div className="project-sections py-5">
            ...
            <div className="row mt-5">
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded"  src={`${process.env.PUBLIC_URL}/images/project/ams2.png`} alt="ams2"/>
              </div>
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded" src={`${process.env.PUBLIC_URL}/images/project/ams3.png`} alt="ams3" />
              </div>
            </div>
