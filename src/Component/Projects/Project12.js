    ...
    <div className="main-wrapper">
      <section className="cta-section theme-bg-light py-5">
        <div className="container single-col-max-width">
          <h2 className="heading text-center">Case Study: FORTUNE MALL</h2>
          <div className="project-intro text-center">
            <p className="mb-0 lead">
            Fortune Mall-Your ultimate shopping, dining, and entertainment destination. Experience luxury, variety, and fun all in one place!
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="project-meta theme-bg-light p-4">
            <div className="row g-4 g-lg-5">
              <div className="col-md-5 col-lg-4 col-xxl-3 d-none d-md-block">
                <img className="project-thumb img-fluid rounded" src={`${process.env.PUBLIC_URL}/images/project/nf1.png`} alt="nf1"  />
              </div>
              <div className="col-12 col-md-7 col-lg-8 col-xxl-9">
                <div className="client-info">
                  <h3 className="client-name font-weight-bold mb-4"> FORTUNE MALL</h3>
                  <ul className="client-meta list-unstyled">
                    <li className="mb-2">
                      <i className="fas fa-industry fa-fw me-2" />
                      <strong>Industry:</strong> Building/Shops
                    </li>
                    <li className="mb-2">
                      <i className="fas fa-users fa-fw me-2" />
                      <strong>Size:</strong> 4+
                    </li>
                    <li className="mb-2">
                      <strong>
                      ...
                      <a className="theme-link" href="https://fortunemallnagpur.in/">https://fortunemallnagpur.in/</a>
                    </li>
                  </ul>
          ...
          <div className="project-sections py-5">
            ...
            <div className="row mt-5">
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded"src={`${process.env.PUBLIC_URL}/images/project/nf1.png`} alt="nf1"  />
              </div>
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded"src={`${process.env.PUBLIC_URL}/images/project/nf1.png`} alt="nf1"  />
              </div>
