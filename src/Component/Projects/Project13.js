    ...
    <div className="main-wrapper">
      <section className="cta-section theme-bg-light py-5">
        <div className="container single-col-max-width">
          <h2 className="heading text-center">Case Study: CHEAP BOOK DEPOT</h2>
          <div className="project-intro text-center">
            <p className="mb-0 lead">
            Cheap Book is a sustainable book depot offering affordable books across all subjects. It promotes education for all by providing budget-friendly options without compromising on quality.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="project-meta theme-bg-light p-4">
            <div className="row g-4 g-lg-5">
              <div className="col-md-5 col-lg-4 col-xxl-3 d-none d-md-block">
                <img className="project-thumb img-fluid rounded" src={`${process.env.PUBLIC_URL}/images/project/cbd1.png`} alt="cbd1"  />
              </div>
              <div className="col-12 col-md-7 col-lg-8 col-xxl-9">
                <div className="client-info">
                  <h3 className="client-name font-weight-bold mb-4">CHEAP BOOK DEPOT</h3>
          ...
          <div className="project-sections py-5">
            ...
            <div className="row mt-5">
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded"src={`${process.env.PUBLIC_URL}/images/project/cbd2.png`} alt="cbd2" />
              </div>
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded" src={`${process.env.PUBLIC_URL}/images/project/cbd3.png`} alt="cbd3" />
              </div>
            </div>
