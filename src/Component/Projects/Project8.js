    ...
    <div className="main-wrapper">
      <section className="cta-section theme-bg-light py-5">
        <div className="container single-col-max-width">
          <h2 className="heading text-center">Case Study: OM SAI BATTERYES</h2>
          <div className="project-intro text-center">
            <p className="mb-0 lead">
            Om Battery World delivers high-performance battery solutions for automotive, industrial, electronics, and renewable sectors—trusted by wholesalers nationwide for quality.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="project-meta theme-bg-light p-4">
            <div className="row g-4 g-lg-5">
              <div className="col-md-5 col-lg-4 col-xxl-3 d-none d-md-block">
                <img className="project-thumb img-fluid rounded"  src={`${process.env.PUBLIC_URL}/images/project/osb1.png`} alt="osb1" />
              </div>
              <div className="col-12 col-md-7 col-lg-8 col-xxl-9">
                <div className="client-info">
                  <h3 className="client-name font-weight-bold mb-4"> OM SAI BATTERYES</h3>
                  <ul className="client-meta list-unstyled">
                    <li className="mb-2">
                      <i className="fas fa-industry fa-fw me-2" />
                      <strong>Industry:</strong> Batteryes
                    </li>
                    <li className="mb-2">
                      <i className="fas fa-users fa-fw me-2" />
                      <strong>Size:</strong> 16+
                    </li>
                    <li className="mb-2">
                      <strong>
                      ...
                      <a className="theme-link" href="https://omsaibattery.in/">https://omsaibattery.in/</a>
                    </li>
                  </ul>
                  <div className="client-bio mb-4">
                  Om Battery World offers reliable, high-quality battery solutions for automotive, industrial, electronics, and renewable sectors—trusted by wholesalers for performance, durability, and innovation.
                  </div>
          ...
          <div className="project-sections py-5">
            ...
            <div className="row mt-5">
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded" src={`${process.env.PUBLIC_URL}/images/project/osb2.png`} alt="osb2" />
              </div>
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded"  src={`${process.env.PUBLIC_URL}/images/project/osb3.png`} alt="osb3 " />
              </div>
            </div>
