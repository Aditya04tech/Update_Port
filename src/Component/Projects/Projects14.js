    ...
    <div className="main-wrapper">
      <section className="cta-section theme-bg-light py-5">
        <div className="container single-col-max-width">
          <h2 className="heading text-center">Case Study: JAI SHIV ASSOCIATES</h2>
          <div className="project-intro text-center">
            <p className="mb-0 lead">
            JaiShivAssociates is a leading name in the construction business we provide all types of services related to Commercial and Residential property projects .When it comes to Interior decoration, Renovation, Modular Kitchen , structural planner and all types of Services to make your Dream Home Beautiful
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="project-meta theme-bg-light p-4">
            <div className="row g-4 g-lg-5">
              <div className="col-md-5 col-lg-4 col-xxl-3 d-none d-md-block">
                <img className="project-thumb img-fluid rounded" src={`${process.env.PUBLIC_URL}/images/project/jsa1.png`} alt="jsa1"/>
              </div>
              <div className="col-12 col-md-7 col-lg-8 col-xxl-9">
                <div className="client-info">
                  <h3 className="client-name font-weight-bold mb-4">JAI SHIV ASSOCIATES</h3>
                  <ul className="client-meta list-unstyled">
                    ...
                    <li className="mb-2">
                      ...
                      <a className="theme-link" href="https://jayshivassociates.com/">https://jayshivassociates.com/</a>
                    </li>
                  </ul>
          ...
          <div className="project-sections py-5">
            ...
            <div className="row mt-5">
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded"src={`${process.env.PUBLIC_URL}/images/project/jsa2.png`} alt="jsa2" />
              </div>
              <div className="col-12 col-lg-6 mb-5">
                <img className="img-fluid rounded" src={`${process.env.PUBLIC_URL}/images/project/jsa3.png`} alt="jsa3" />
              </div>
            </div>
